...
//    cout << "shit! line 71 main.cpp color: " << color << '\n';
     gameOver(color);
     return false;
...
int colorMatch(move myMove, char piece, char color){
   // cout << "99 color " << color << " piece " << piece; 
...
void compMove(char color){
    cout << "line 113 color: " << color;
    move moves[290];
//THIS LINE IS CHANGING COLOR!!??
    int i = state.moveGen(color, moves);
    cout << "line 116 color: " << color;
    time_t seconds;
    time(&seconds);
